...
def define_parser(parser):
    ...
    graph_parser = subparsers.add_parser(
        'graph',
        description="Create a graph of the training data.",
        help="Create a graph of the training data.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    graph_training.define_parser(graph_parser)

    replace_tgt_parser = subparsers.add_parser(
        'replace_tgt_unk',
        description="Replace UNK tags using a dictionnary.",
        help="Replace UNK tags using a dictionnary.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    replace_tgt_unk.define_parser(replace_tgt_parser)

    recap_parser = subparsers.add_parser(
        'recap',
        description="Generate recap of experiments.",
        help="Generate recap of experimets.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    expe_recap.define_parser(recap_parser)

    bleu_parser = subparsers.add_parser(
        'bleu',
