...
#     translation_method_group.add_argument("--beam_opt", default = False, action = "store_true")
    ...
    management_group.add_argument("--load_back_translation_model_config", nargs="+", help="gives a list of models used for reverse translation comparison")
    management_group.add_argument("--back_translation_dic")
