...
if __name__ == '__main__':
    ...
    parser.add_argument("--num_bpe_merge_operations", type=int, default=50, help="Number of merge operations that the BPE model should perform on the training vocabulary to learn the BPE codes.")
    parser.add_argument("--joint_bpe_model", default=True, help="Do you want to learn a single BPE model for both the source and target side corpora so that the merge operations are consistent on both sides? This might be useful in the cases where the languages share cognates.")
