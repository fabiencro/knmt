...
def beam_search_all(gpu, encdec, eos_idx, src_data, beam_width, beam_pruning_margin, nb_steps, beam_opt, 
       nb_steps_ratio, use_post_score_length_normalization, 
       groundhog,
...
def define_parser(parser):
    ...
    parser.add_argument("--use_post_score_length_normalization", default = True, action = "store_true")
...
#             ct = convert_idx_to_string(t, tgt_voc + ["#T_UNK#"])
        ...
        translate_to_file_with_beam_search(args.dest_fn, args.gpu, encdec_list, eos_idx, src_data, args.beam_width, args.beam_pruning_margin,
                                           ...
                                           args.nb_steps_ratio, args.use_post_score_length_normalization, 
                                           args.groundhog,
