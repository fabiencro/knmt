...
do
	echo "bash /home/raj/softwares-and-scripts/NNProjects/knmt/nmt_chainer/mr_decode.sh $model_config $model_path $save_path/src-shard-$i $save_path/tgt-shard-$i $ppp_path $tgt_lang"
...
gxpc js -a work_file=$save_path/gxp_instructions  -a cpu_factor=0.5
